 ...
 */
 ...
 require(\ProcessWire\wire('files')->compile($config->paths->adminTemplates . 'controller.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); 
